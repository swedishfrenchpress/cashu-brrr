...
<!-- Add touch-none to prevent unwanted touch interactions -->
<div class="relative min-h-[100dvh] w-full overflow-auto touch-none">
    ...
    <div class="mx-auto max-w-4xl">
      ...
      <div class="text-center mb-0 relative flex flex-col items-center">
        <h1 class="font-['Bank_TM'] text-[#9FE870] flex flex-col gap-[-20px] md:gap-[-10px] relative">
          <span 
            class="text-[64px] md:text-[96px] leading-none glow-effect mouse-reactive"
            style="--mouse-x: {mouseX}px; --mouse-y: {mouseY}px;"
          >Money printer</span>
          <span 
            class="text-[64px] md:text-[96px] leading-none mt-[5px] md:mt-[10px] glow-effect mouse-reactive"
            style="--mouse-x: {mouseX}px; --mouse-y: {mouseY}px;"
          >Go</span>
          <span 
            class="text-[120px] md:text-[200px] leading-none mt-[-20px] md:mt-[-40px] glow-effect mouse-reactive transform -rotate-6"
            style="--mouse-x: {mouseX}px; --mouse-y: {mouseY}px;"
          >Brrrrrr</span>
        </h1>
      </div>
